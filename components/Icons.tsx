...
export const ChartLineIcon = ({ className, width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    fill="currentColor" 
...
export const GlobeIcon = ({ className, width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className}
    fill="none" 
...
export const RefreshIcon = ({ className, width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    fill="none"
...
export const CopyIcon = ({ className, width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    className={className}
    fill="none" 
...
export const DownloadIcon = ({ className, width = 24, height = 24 }: { className?: string; width?: number; height?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    fill="none" 
