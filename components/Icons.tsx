...
export const TrendingDownIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M3 21V3H5V19H21V21H3Z" />
    <path d="M19.2929 17.2929L20.7071 15.8787L14 9.17157L10 13.1716L6.70711 9.87868L5.29289 11.2929L10 16L14 12L19.2929 17.2929Z" />
  </svg>
);
