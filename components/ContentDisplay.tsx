...
string }) {
 ...
 viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21
...
''}`} />
            ...
            <ul className="space-y-3">
              ...
              {result.sources.map((source, index) => (
                ...
                source.web && <li key={index} className="flex items-start">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3 mt-1 text-primary-500 flex-shrink-0" fill="none"
 viewBox="0 0 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round"
 strokeWidth="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
                  ...
                  <a href={source.web.uri} target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:underline hover:text-primary-800
      ...
      {showLanguageToggle && (
        ...
        <div className="absolute top-4 right-4 z-10">
          ...
          <button
            ...
            title={isEnglishMode ? "Switch to Local Language" :
"Switch to English"}
